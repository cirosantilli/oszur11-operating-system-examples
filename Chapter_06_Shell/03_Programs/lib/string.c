 ...
 * \returns Returns an integral value indicating the relationship between the
 ...
 * \param s String
 * \param c Character
 * \returns Pointer to first appearance of c in s, NULL if none
 */
 ...
 * \returns Pointer to first appearance of s2 in s1, NULL if none
 */
