...
CFLAGS="-c -O3 -m32 -Wall -ffreestanding -nostdlib -fno-stack-protector"
LDFLAGS="-O3 -melf_i386 -e arch_start -Ttext=0x100000"

#compile
gcc $CFLAGS startup.S
gcc $CFLAGS hello.c

#link
ld $LDFLAGS startup.o hello.o -o $PROJECT.elf
