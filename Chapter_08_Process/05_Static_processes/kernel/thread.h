...
kthread_t *k_create_thread ( void *start_func, void *param, void *exit_func,
	int prio, void *stack, size_t stack_size, int run, kprocess_t *proc );
...
extern inline kprocess_t *k_get_thread_process ( kthread_t *thread );
extern inline kprocess_t *k_get_active_process ();
